...
\renewcommand{\cvWebsite}{emilydoesastro.com}
...
Astronomer with interests in machine learning and statistics. Highly skilled programmer with 10+ years of programming experience. During my Ph.D., I used \emph{Gaia} data and various machine learning techniques to create the largest catalogue of star clusters in the Milky Way to date, including detecting hundreds of new objects. Looking to work on exciting data analysis projects requiring novel computational solutions.
