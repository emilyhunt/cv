...
\begin{etaremune}
    \item \publication 
        {Kristen C. Dage, Emily L. Hunt \emph{et al.}}
        {2026}
        {The Secret Lives of Open Clusters: a Multiwavelength Examination of Three Open Clusters}
        [PASA, accepted]
        [https://ui.adsabs.harvard.edu/abs/2026arXiv260108087D/abstract]
        % [1]
    \item \publication 
